...
pub fn upload_lexicons_response_decoder() -> decode.Decoder(
  UploadLexiconsResponse,
) {
...
pub fn parse_upload_lexicons_response(
  body: String,
) -> Result(UploadLexiconsResponse, String) {
