...
pub fn delete_o_auth_client_response_decoder() -> decode.Decoder(DeleteOAuthClientResponse) {
...
pub fn delete_o_auth_client_response_to_json(input: DeleteOAuthClientResponse) -> json.Json {
  json.object([#("deleteOAuthClient", json.bool(input.delete_o_auth_client))])
}

pub fn delete_o_auth_client(client: squall.Client, client_id: String) -> Result(Request(String), String) {
...
pub fn parse_delete_o_auth_client_response(body: String) -> Result(DeleteOAuthClientResponse, String) {
