...
pub fn create_o_auth_client_response_decoder() -> decode.Decoder(CreateOAuthClientResponse) {
  use create_o_auth_client <- decode.field("createOAuthClient", o_auth_client_decoder())
  decode.success(CreateOAuthClientResponse(
    create_o_auth_client: create_o_auth_client,
  ))
}

pub fn create_o_auth_client_response_to_json(input: CreateOAuthClientResponse) -> json.Json {
  json.object(
    [
...
pub fn create_o_auth_client(client: squall.Client, client_name: String, client_type: String, redirect_uris: List(String), scope: String) -> Result(Request(String), String) {
...
pub fn parse_create_o_auth_client_response(body: String) -> Result(CreateOAuthClientResponse, String) {
