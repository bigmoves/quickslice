        ...
        case result {
          ...
          squall_cache.Data(data) -> {
            case data.recent_activity {
              [] ->
                html.div([attribute.class("py-8 text-center text-zinc-600 text-xs")], [
                  element.text("No activity in the last " <> int.to_string(hours) <> " hours"),
                ])
          ...
          html.div(
            ...
            [
              ...
              html.div([attribute.class("flex gap-2")], [
                ...
                html.span([attribute.class("text-zinc-400")], [element.text(date_formatter.format_datetime_local(entry.timestamp))]),
              ]),
              // Full DID
              html.div([attribute.class("flex gap-2")], [
